...
public class Program
{
    ...
    public int[] Task_1_6(int[,] A)
    {
        ...
        int columns = A.GetLength(1);
        answer = new int[rows];
        if (rows != 4 || columns != 7) return default;
        else
        {
    ...
    public int[,] Task_1_12(int[,] A)
    {
        ...
        int rows = A.GetLength(0);
        int columns = A.GetLength(1);
        if (rows != 6 || columns != 7) { return default; }
        int max = A[0, 0];
    ...
    public int[,] Task_1_30(int[,] B)
    {
        ...
        if (rows * columns != 25) { return default; }
    ...
    public int[,] Task_2_3(int[,] A)
    {
        ...
        int rows = A.GetLength(0);
        int columns = A.GetLength(1);
        if (rows != 10 || columns != 5) { return default; }
        for (int j = 0; j < columns; j++)
        {
            int max = A[0, j];
            int imax = 0;
    ...
    public int[,] Task_2_4(int[,] A, int[] B)
    {
        ...
        int columns = A.GetLength(1);
        int k = 0;
        if (rows != 7 || columns != 5 || B.Length != 5) { return default; }
        for (int j = 0; j < columns; j++)
        {
            int max = A[0, j];
            int imax = 0;
    ...
    public int[,] Task_2_7(int[,] A)
    {
        ...
        int rows = A.GetLength(0);
        int columns = A.GetLength(1);
        if (rows * columns != 36) { return default; }
        int max = A[0, 0];
        int imax = 0;
        for (int i = 0; i < rows; i++)
        {
    ...
    public int[,] Task_2_8(int[,] B)
    {
        ...
        int rows = B.GetLength(0);
        int columns = B.GetLength(1);
        if (rows != 6 || columns != 6) { return default; }
    ...
    public int[,] Task_3_11(int[,] matrix)
    {
        ...
        int[,] A = new int[rows - count, columns];
        int k = 0;
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
